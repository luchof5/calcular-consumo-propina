...
function actualizarResumen() {
    ...
    pedido.forEach( articulo => {
        ...
        btnEliminar.textContent = 'Elminar del Pedido';
...
function elimanrProducto(id) {
    ...
    // El producto se eliminó por lo tanto regresamos la cantidad a 0 en le formulario
